...
class UpdateProjectRequest extends BaseRequest
{
    ...
    {
        return [
            'quotation_id' => 'sometimes|required|integer|exists:quotations,quotation_id',
            'client_id' => 'sometimes|required|integer|exists:clients,client_id',
            'location_id' => 'sometimes|required|integer|exists:locations,location_id',
            'status_id' => 'sometimes|required|integer|exists:project_statuses,status_id',
            'project_name' => 'sometimes|required|string|max:255',
            'start_date' => 'sometimes|required|date',
            'estimated_end_date' => 'sometimes|required|date|after:start_date',
    ...
    public function messages(): array
    {
        return array_merge(parent::messages(), [
            ...
            'actual_end_date.after' => 'La fecha real de finalización debe ser posterior a la fecha de inicio.',
