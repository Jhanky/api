...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        // \Illuminate\Foundation\Http\Middleware\ConvertEmptyStringsToNull::class, // Deshabilitado temporalmente
    ];
    ...
    protected $middlewareGroups = [
        ...
        'api-web' => [
            \App\Http\Middleware\PlatformDetection::class,
            \App\Http\Middleware\Shared\LoggingMiddleware::class,
            \App\Http\Middleware\Api\WebOptimization::class,
            \App\Http\Middleware\Shared\ResponseOptimization::class,
            \Illuminate\Routing\Middleware\ThrottleRequests::class.':api',
            \Illuminate\Routing\Middleware\SubstituteBindings::class,
        ],
    ...
    protected $middlewareAliases = [
        ...
        'siigo.token' => \App\Http\Middleware\VerifySiigoToken::class,
        ...
        'shared.response.optimization' => \App\Http\Middleware\Shared\ResponseOptimization::class,
    ];
}
